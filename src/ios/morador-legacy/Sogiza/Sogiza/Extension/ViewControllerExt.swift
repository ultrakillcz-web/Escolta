...
extension UIViewController {
    ...
    public func addLeftBarButtonWithImage(_ buttonImage: UIImage) {
        let leftButton: UIBarButtonItem = UIBarButtonItem(image: buttonImage, style: UIBarButtonItemStyle.plain, target: self, action: #selector(self.leftClick))
        navigationItem.leftBarButtonItem = leftButton
    }
    
    public func addRightBarButtonWithImage(_ buttonImage: UIImage) {
        let rightButton: UIBarButtonItem = UIBarButtonItem(image: buttonImage, style: UIBarButtonItemStyle.plain, target: self, action: #selector(self.rightClick))
...
//        navigationItem.rightBarButtonItem = rightButton
    ...
    func alert(alertmessage: String) {
        let alert = UIAlertController(title: APP_NAME, message: alertmessage, preferredStyle: UIAlertControllerStyle.alert)
